...
export default function Project({
    ...
    return (
        <motion.div 
            ...
            className="group sm:mb-8 mb-3 last:mb-0"
            >
            <section className='dark:text-white dark:bg-white/10 dark:hover:bg-white/20 bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8'>
